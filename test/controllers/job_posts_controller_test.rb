...
class JobPostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create job_post" do
    assert_difference('JobPost.count') do
      post job_posts_url, params: { job_post: { description: @job_post.description, title: @job_post.title } }
    end
  ...
  test "should update job_post" do
    patch job_post_url(@job_post), params: { job_post: { description: @job_post.description, title: @job_post.title } }
