...
class JobApplicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create job_application" do
    assert_difference('JobApplication.count') do
      post job_applications_url, params: { job_application: { cover_letter: @job_application.cover_letter, email: @job_application.email, ph_no: @job_application.ph_no } }
    end
  ...
  test "should update job_application" do
    patch job_application_url(@job_application), params: { job_application: { cover_letter: @job_application.cover_letter, email: @job_application.email, ph_no: @job_application.ph_no } }
